...
Enforce a consistent Kotlin code style across the repository via ktlint, applied both in the Gradle build and on agent edits through a Claude Code hook.
